...
/* todo stevedan*/
crtpzDistanceSetpointRequest::crtpzDistanceSetpointRequest(
	float roll,
	float pitch,
	float yawrate,
	float zDistance)
	: header(0X07, 0), type(2)
{
	this->roll = roll;
	this->pitch = pitch;
	this->yawrate = yawrate;
...
// struct sendzDistanceSetpointRequest
// {
//   sendzDistanceSetpointRequest(
//     float roll,
//     float pitch,
//     float yawrate,
//     float zDistance);
...
// CHECKSIZE(sendzDistanceSetpointRequest)
